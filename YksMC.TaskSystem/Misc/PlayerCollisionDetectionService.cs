...
namespace YksMC.Behavior.Misc
{
    public class PlayerCollisionDetectionService : IPlayerCollisionDetectionService
    {
        ...
        public IWorld UpdatePlayerPosition(IWorld world, IVector3<double> velocity)
        {
            ...
            bool isOnGround = firstHit.HitY && velocity.Y < 0;
            if (isOnGround)
            {
            ...
            return world.ReplaceCurrentDimension(dimension.ReplaceEntity(entity));
        }
