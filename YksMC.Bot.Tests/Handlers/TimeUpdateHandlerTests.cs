...
namespace YksMC.Bot.Tests.Handlers
{
    ...
    public class TimeUpdateHandlerTests
    {
        ...
        public void ApplyTimeUpdate_PositiveValues_CorrectAgeTimeSet()
        {
            ...
            handler.ApplyEvent(packet, world);

            Assert.AreEqual(12341337, world.GetCurrentDimension().AgeAndTime.AgeTicks);
            Assert.AreEqual(1000, world.GetCurrentDimension().AgeAndTime.TimeTicks);
        }
        ...
        private IWorld GetWorld()
        {
            ...
            IWorld world = new World(new Dictionary<IPlayerId, IPlayer>(), null, dimensions, null);
            return world;
        }
